...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA7     ------> ADC_IN7 
    */
    GPIO_InitStruct.Pin = TEMP1_Pin|TEMP2_Pin|TEMP3_Pin|V_FUSE_Pin 
                          |V_CAP__Pin|V_CAP_A6_Pin|V_VCC_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC_IN7 
    */
    HAL_GPIO_DeInit(GPIOA, TEMP1_Pin|TEMP2_Pin|TEMP3_Pin|V_FUSE_Pin 
                          |V_CAP__Pin|V_CAP_A6_Pin|V_VCC_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    PB15     ------> SPI2_MOSI 
    */
    GPIO_InitStruct.Pin = FLSH_SCK_Pin|FLSH_MISO_Pin|FLSH_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI 
    */
    HAL_GPIO_DeInit(GPIOB, FLSH_SCK_Pin|FLSH_MISO_Pin|FLSH_MOSI_Pin);
