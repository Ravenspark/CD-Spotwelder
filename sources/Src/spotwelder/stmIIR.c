...
/**
  ...
  * @param x: Input array
  * @param IIRCoeff: IIR Filter Coefficients, an array of 20 bytes
  * @param ny: the number of output samples
  * @retval : None
  */
void iir_biquad(uint8_t *y, uint8_t *x, int8_t *IIRCoeff, uint16_t ny)
{
  uint16_t i;
  uint16_t w1_2 = 0, w1_1 = 0, w1;
  uint16_t w2_2 = 0, w2_1 = 0, w2;
  uint16_t w3_2 = 0, w3_1 = 0, w3;
  uint16_t w4_2 = 0, w4_1 = 0, w4;
